/**
  * Copyright (c) 2015 - 2016, Yuriy Stul. All rights reserved
  */
...
/**
  ...
  * @author Yuriy Stul
  */
case class ParamText(textValue: String) extends Param {
  /**
    * Implements operator > for ParamText See [[Param.>]]
    */
	override def >(x: Param):Boolean = x match {
...
/**
  ...
  * @author Yuriy Stul
  */
case class ParamDouble(doubleValue: Double) extends Param {
...
/**
  ...
  * @author Yuriy Stul
  */
case class ParamInt(intValue: Int) extends Param {
...
/**
  ...
  * @author Yuriy Stul
  */
case class ParamDate(dateValue: Date) extends Param {
