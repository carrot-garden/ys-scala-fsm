...
class TransitionTest extends FlatSpec with Matchers {
	"A Transition" should "support equals" in {
		...
		val ip1 = new InputParams(Map("p1" -> 123, "p2" -> 321))
		val i1 = new Input(it1, ip1)
		val ss1 = new State("ss1")
		val ds1 = new State("ds1")
		val c1 = List(new TransitionCondition("t1", Equal, 123.05), new TransitionCondition("t2", Less, 17))
		val t1 = new Transition(i1, 1, ss1, ds1, c1, ConditionAggregationType.All)

		val it2 = new InputType("it1")
		val ip2 = new InputParams(Map("p1" -> 123, "p2" -> 321))
		val i2 = new Input(it2, ip2)
		val ss2 = new State("ss1")
		val ds2 = new State("ds1")
		val c2 = List(new TransitionCondition("t1", Equal, 123.05), new TransitionCondition("t2", Less, 17))
		...
		val c3 = List(new TransitionCondition("t1", Equal, 123.05), new TransitionCondition("t2", Less, 17))
