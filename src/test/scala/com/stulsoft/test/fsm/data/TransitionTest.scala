...
class TransitionTest extends FlatSpec with Matchers {
	"A Transition" should "support equals" in {
		...
		val c1 = List(new TransitionCondition("t1", "op1", 123.05), new TransitionCondition("t2", "op2", 17))
		...
		val c2 = List(new TransitionCondition("t1", "op1", 123.05), new TransitionCondition("t2", "op2", 17))
		...
		val c3 = List(new TransitionCondition("t1", "op1", 123.05), new TransitionCondition("t2", "op2", 17))
